...
class Graph:
    ...
    def node(self, label: str, id: str, **props) -> str:
        ...
        _check_props(f"node {label}", props, spec["props"])
    ...
    def edge(self, type: str, src: str, dst: str, **props) -> str:
        ...
        _check_props(f"edge {type}", props, spec["props"])
    ...
    def write(self, out_dir: Path) -> None:
        ...
        (out_dir / "ontology.json").write_text(json.dumps(ontology, indent=1, sort_keys=True))
