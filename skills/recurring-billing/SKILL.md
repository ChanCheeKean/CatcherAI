...
description: How to trace recurring charges and cancellation. Load for subscription Disputes.
---

# Recurring billing
1. Read `graph_schema` descriptions to identify each charged plan or subscription and the Card used.
2. A cancellation confirmation proves only the plan it names; compare it with the billed plan.
