...
description: How to reconcile disputed amounts and payments. Load for amount questions.
---

# Payments and credits
1. Read `graph_schema` descriptions to find how charges, credits, other-means payments and bills connect.
