...
description: How to separate Amex-funded benefits from Merchant pricing. Load for Offers and Card benefits.
---

# Offers and benefits
1. Read `graph_schema` descriptions to locate the Offer or benefit and its terms.
2. Determine whether Amex or the Merchant funds the promised value; a missing Amex-funded credit is not a Merchant billing error.
3. An Amex Offer applies only to the Card on which it was enrolled; compare that Card with the Card charged, and who holds each.
